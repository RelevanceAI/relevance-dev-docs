...
- The name and description of the endpoint (`app.post(name=...)`) becomes the same name and description of the Tool. This is crucial when a tool is equipped to an agent since its used in the prompt for agents.
- The typing and description of params sets the user inputs for the tool.
